...
const initialNotifications: Notification[] = [
  {
    id: "1",
    type: "repo-alert",
    title: "New 'React' project found",
    description: "A new repository matches your profile with a 94% match score!",
    timeAgo: "5m ago",
    read: false,
    priority: "high",
  },
  {
    ...
    description: '"Great solution for the hydration issue! Have you tried..."',
    timeAgo: "12m ago",
    read: false,
    author: { name: "John Park", initials: "JP" },
  },
  {
    id: "3",
    type: "repo-alert",
    title: "New 'TypeScript' project found",
    description: "shadcn/ui has beginner-friendly issues matching your skills.",
    timeAgo: "1h ago",
    read: false,
    priority: "high",
  },
  {
    ...
    description: '"@janedoe you should check out the FastAPI docs refactor!"',
    timeAgo: "2h ago",
    read: false,
  ...
  },
  {
    id: "5",
    type: "pr-update",
    title: "PR #4281 review requested",
    description: "vercel/next.js - Your fix for the date formatting issue needs review.",
    timeAgo: "3h ago",
    read: true,
  },
  {
    id: "6",
    type: "social",
    title: "Marcus liked your post",
    description: "Your post about Supabase contributions got 12 new likes.",
    timeAgo: "4h ago",
    read: true,
  ...
  },
  {
    id: "7",
    type: "repo-alert",
    title: "New 'Python' project found",
    description: "LangChain added 3 good-first-issues for Python contributors.",
    timeAgo: "5h ago",
    read: true,
    priority: "high",
  },
  {
    ...
    description: "Alex Rivera is now following your activity.",
    timeAgo: "6h ago",
    read: true,
